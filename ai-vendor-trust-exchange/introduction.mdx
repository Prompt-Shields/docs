...
<Warning>
**In development.** ATX is at design stage. The design is settled and the first code — a walking skeleton with a seeded catalog and two server-rendered pages — is the next thing to land. Nothing described here is live yet; these pages document the product being built, not a service you can use today.
</Warning>
...
<Steps>
  ...
  <Step title="Independence is structural">
    Vendor money can buy presence and lead-gen. It can never buy a rating input, a ranking position, or an answer. This is enforced by separate services and isolation tests, not by policy alone. See [Independence](/ai-vendor-trust-exchange/independence).
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Pricing model" icon="tag" href="/ai-vendor-trust-exchange/pricing">
    Priced per vendor monitored, with the free/paid line drawn on freshness. Draft bands, not a quote.
  </Card>
</CardGroup>
